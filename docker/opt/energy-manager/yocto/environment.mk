...
export TQEM_DEPLOY_PATH      ?= $(TQEM_YOCTO_PROJECT_PATH)/$(TQEM_DEPLOY_DIR)
...
export TQEM_EMOS_SNAPSHOT_DEPLOY_PATH ?= $(TQEM_BASE_DEPLOY_PATH)/$(TQEM_SNAPSHOTS_DIR)/emos/$(TQEM_GIT_REF_SUBDIR)
export TQEM_EMOS_RELEASE_DEPLOY_PATH  ?= $(TQEM_BASE_DEPLOY_PATH)/$(TQEM_RELEASES_DIR)/emos/$(TQEM_GIT_REF_SUBDIR)
export TQEM_DEPLOY_SNAPSHOT_PATH      ?= $(TQEM_EMOS_SNAPSHOT_DEPLOY_PATH)
export TQEM_DEPLOY_RELEASE_PATH       ?= $(TQEM_EMOS_RELEASE_DEPLOY_PATH)
